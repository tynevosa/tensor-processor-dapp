  ...
  return (
    <div className="w-2/5  p-6 border border-[#242835] rounded-lg  ">
      <div className="flex justify-between ">
        ...
        <div>
          <button className="bg-[#97AEF3] hover:bg-[#8194ced5] rounded-lg px-4 flex gap-2 py-3 text-[#0C0C0C] text-lg font-semibold font-chakra-petch justify-center items-center ">
