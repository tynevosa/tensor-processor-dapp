...
const AIPrompt = (props: any) => {
  return (
    <div className="md:w-1/4 mb-6 cursor-pointer">
      <div
        className="m-4 px-8 pt-6 pb-6 rounded-[4px] text-white border border-2 border-[#191B24]"
      ...
      >
        <div className="flex items-center">
          <Image
            src={iconAI}
            alt="logo"
            className="md:w-12 md:h-12 rounded-[2px] mr-2"
          />
          <div className="mt-4">
            <h1 className="text-2xl">
              <b>{props.datas.title}</b>
            </h1>
            <p className="h-10  text-base leading-tight mt-3 text-2xl">
              {props.datas.engin}
            </p>
          </div>
        </div>
