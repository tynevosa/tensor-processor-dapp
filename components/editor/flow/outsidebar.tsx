...
const OutputBar: React.FC<OutputProps> = ({ question, queChange, output, showResult }) => {
  ...
  return (
    <div className='absolute z-2  mt-24 right-side '>
      <div className=" mt-8 max-w-[330px] w-full w-[300px]">
        <div className='border border-[#1D1F29] border-2 bg-[#101016]  bg-opacity-95'>
          <div className='flex text-white border border-[#1D1F29] border-2 px-2 pt-3 pb-3 font-bold'><FaBolt className='text-[24px] text-[yellow] pr-2' />   Global Input</div>
          <div className='p-4'>
        ...
        <div className='border border-[#1D1F29] border-2 mt-8 bg-[#101016] bg-opacity-95'>
          <div className='flex justify-between text-white border border-[#1D1F29] border-2 px-2 pt-3 pb-3 font-bold gap-2'>
