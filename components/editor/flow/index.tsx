...
const OverviewFlow: React.FC = () => {
  ...
  const jsonStructData = [
    { "template": "I want to make funny story to hear my young sister\n{{ character1 }},{{ character2 }}\nrelationship\n{{ relationship }}\nmake funny story", "model_id": 1, "model": { "name": "gpt-3.5-turbo", "providers": { "id": 1, "name": "openai" }, "config_steps": { "stop": { "max": 4, "min": 0 }, "top_k": { "max": 100, "min": 1, "step": 1 }, "top_p": { "max": 1, "min": 0, "step": 0.01 }, "truncate": { "max": null, "min": 0 }, "typical_p": { "max": 1, "min": 0.01, "step": 0.01 }, "max_tokens": { "max": 4096, "min": 1, "step": 1 }, "temperature": { "max": 2, "min": 0, "step": 0.05 }, "presence_penalty": { "max": 2, "min": -2, "step": 0.01 }, "frequency_penalty": { "max": 2, "min": -2, "step": 0.01 } } }, "default_config": { "stop": [], "top_k": 40, "top_p": 0.95, "truncate": null, "do_sample": false, "typical_p": null, "watermark": false, "max_tokens": 4096, "temperature": 0.7, "return_full_text": null, "frequency_penalty": null }, "config": { "stop": [], "top_k": 40, "top_p": 0.95, "truncate": null, "do_sample": false, "typical_p": null, "watermark": false, "max_tokens": 4096, "temperature": 0.7, "return_full_text": true, "frequency_penalty": 0 }, "supported_inputs": { "character1": "val", "character2": "lucky", "relationship": "friend" }, "system_template": "You are a helpful assistant.", "id": "6294", "userId": 1 },
    { "template": "Context: {{ informations }}\n\nQuestion: {{ question }}", "model_id": 1, "model": { "name": "gpt-3.5-turbo", "providers": { "id": 1, "name": "openai" }, "config_steps": { "stop": { "max": 4, "min": 0 }, "top_k": { "max": 100, "min": 1, "step": 1 }, "top_p": { "max": 1, "min": 0, "step": 0.01 }, "truncate": { "max": null, "min": 0 }, "typical_p": { "max": 1, "min": 0.01, "step": 0.01 }, "max_tokens": { "max": 4096, "min": 1, "step": 1 }, "temperature": { "max": 2, "min": 0, "step": 0.05 }, "presence_penalty": { "max": 2, "min": -2, "step": 0.01 }, "frequency_penalty": { "max": 2, "min": -2, "step": 0.01 } } }, "default_config": { "stop": [], "top_k": 40, "top_p": 1, "max_tokens": 4096, "temperature": 0.7, "presence_penalty": 0, "frequency_penalty": 0 }, "config": { "stop": [], "top_k": 40, "top_p": 1, "max_tokens": 4096, "temperature": 0.7, "presence_penalty": 0, "frequency_penalty": 0 }, "supported_inputs": { "informations": "lucky", "question": "who are you" }, "system_template": "You are a chatbot. Your task is to answer questions based on the context. If the answer is not in the context, respond with &quot;I have no information on that&quot; and nothing more than that.", "id": "6278", "userId": 1 },
    { "template": "Read this article and forsee which 3 popular search terms might bring the article up in a Google search. Provide a numbered list of these search terms.\n\nArticle: {{ article }} \n\nOutput:", "model_id": 1, "model": { "name": "gpt-3.5-turbo", "providers": { "id": 1, "name": "openai" }, "config_steps": { "stop": { "max": 4, "min": 0 }, "top_k": { "max": 100, "min": 1, "step": 1 }, "top_p": { "max": 1, "min": 0, "step": 0.01 }, "truncate": { "max": null, "min": 0 }, "typical_p": { "max": 1, "min": 0.01, "step": 0.01 }, "max_tokens": { "max": 4096, "min": 1, "step": 1 }, "temperature": { "max": 2, "min": 0, "step": 0.05 }, "presence_penalty": { "max": 2, "min": -2, "step": 0.01 }, "frequency_penalty": { "max": 2, "min": -2, "step": 0.01 } } }, "default_config": { "stop": [], "top_k": 40, "top_p": 1, "max_tokens": 4096, "temperature": 0.7, "presence_penalty": 0, "frequency_penalty": 0 }, "config": { "stop": [], "top_k": 40, "top_p": 1, "max_tokens": 4096, "temperature": 0.7, "presence_penalty": 0, "frequency_penalty": 0 }, "supported_inputs": { "article": "about drawing" }, "system_template": "You are an SEO expert", "id": "6280", "userId": 1 },
    { "template": "Rewrite &quot;{{ answer }}&quot; into the style of a cute puppy managing a pet store. Do not add new information.", "model_id": 1, "model": { "name": "gpt-3.5-turbo", "providers": { "id": 1, "name": "openai" }, "config_steps": { "stop": { "max": 4, "min": 0 }, "top_k": { "max": 100, "min": 1, "step": 1 }, "top_p": { "max": 1, "min": 0, "step": 0.01 }, "truncate": { "max": null, "min": 0 }, "typical_p": { "max": 1, "min": 0.01, "step": 0.01 }, "max_tokens": { "max": 4096, "min": 1, "step": 1 }, "temperature": { "max": 2, "min": 0, "step": 0.05 }, "presence_penalty": { "max": 2, "min": -2, "step": 0.01 }, "frequency_penalty": { "max": 2, "min": -2, "step": 0.01 } } }, "default_config": { "stop": [], "top_k": 40, "top_p": 1, "max_tokens": 4096, "temperature": 0.7, "presence_penalty": 0, "frequency_penalty": 0 }, "config": { "stop": [], "top_k": 40, "top_p": 1, "max_tokens": 4096, "temperature": 0.7, "presence_penalty": 0, "frequency_penalty": 0 }, "supported_inputs": { "answer": "I am not bot" }, "system_template": "You are a chat bot.", "id": "6279", "userId": 1 }
  ];
